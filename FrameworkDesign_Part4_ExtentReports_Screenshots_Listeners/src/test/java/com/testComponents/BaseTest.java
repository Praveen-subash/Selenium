...
public class BaseTest {
	...
	public String getScreenshot(String testCaseName, WebDriver driver) throws IOException {  //**91  //**96 adding parametre driver
		//If 96 is not there this will point current class driver.
		//current class driver will not have driver power bcos this gets run as part of listeners
		//Before method wouldnt have got executed so driver power wont be there
